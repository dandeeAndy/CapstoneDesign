...
# ---------------------------------------------------------------------------------------------------------------------
        ...
        scaled_pixmap = self.logo_pixmap.scaled(500, 500, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        self.logo_label.setPixmap(scaled_pixmap)
        self.logo_label.setScaledContents(True)  # QLabel 크기에 맞춰 이미지의 내용을 스케일합니다.
...
# ---------------------------------------------------------------------------------------------------------------------
        # 옵션 버튼 설정
        self.option_buttons = [
            OptionButton('domfor_ON_updated.png', 'domfor_OFF_updated.png', 'Option1', self),
            OptionButton('fragile_ON_updated.png', 'fragile_OFF_updated.png', 'Option2', self),
            OptionButton('courier_ON_updated.png', 'courier_OFF_updated.png', 'Option3', self),
        ]
