...
class OptionButton(QLabel):
    ...
    def setScaledPixmap(self):
        if self.is_on:
            scaled_pixmap = self.on_pixmap.scaled(self.size(), Qt.KeepAspectRatio, Qt.SmoothTransformation)
        else:
            scaled_pixmap = self.off_pixmap.scaled(self.size(), Qt.KeepAspectRatio, Qt.SmoothTransformation)
