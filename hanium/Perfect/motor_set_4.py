...
# Pick_Angle
pick_position = {
    '1_1': [IK.c_deg(-108, 172, 450), IK.c_deg(-108, 172, 604), IK.c_deg(-108, 172, 450)],
    '2_1': [IK.c_deg(-111, 177, 450), IK.c_deg(-111, 177, 558), IK.c_deg(-111, 177, 450)],
    '3_1': [IK.c_deg(-114, 181, 450), IK.c_deg(-114, 181, 506), IK.c_deg(-114, 181, 450)],
    '1_2': [IK.c_deg(67, 172, 450),   IK.c_deg(67, 172, 603),   IK.c_deg(67, 172, 450)],
    '2_2': [IK.c_deg(71, 175, 450),   IK.c_deg(71, 175, 562),   IK.c_deg(71, 175, 450)],
    '3_2': [IK.c_deg(70, 180, 450),   IK.c_deg(70, 180, 504),   IK.c_deg(70, 180, 450)],
    '1_3': [IK.c_deg(60, 310, 450),   IK.c_deg(60, 310, 586),   IK.c_deg(60, 310, 450)],
    '2_3': [IK.c_deg(63, 315, 450),   IK.c_deg(63, 315, 545),   IK.c_deg(63, 315, 450)],
    '3_3': [IK.c_deg(65, 318, 450),   IK.c_deg(65, 318, 498),   IK.c_deg(65, 318, 450)],
    '1_4': [IK.c_deg(-97, 309, 450),  IK.c_deg(-97, 309, 587),  IK.c_deg(-97, 309, 450)],
    '2_4': [IK.c_deg(-105, 316, 450), IK.c_deg(-105, 316, 546), IK.c_deg(-105, 316, 450)],
    '3_4': [IK.c_deg(-112, 320, 450), IK.c_deg(-112, 320, 498), IK.c_deg(-112, 320, 450)]
}
# ---------------------------------------------------------------------------------------------------------------
# Place_Angle
place_position = {
