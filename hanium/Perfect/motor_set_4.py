...
place_position = {
    ...
    'B1': [(IK.c_deg(-117, -238, 450) + [0]), (IK.c_deg(-117, -238, 593) + [0])],
    'B2': [(IK.c_deg(-252, -235, 450) + [0]), (IK.c_deg(-252, -235, 577) + [0])],
    'B3': [(IK.c_deg(-109, -140, 450) + [0]), (IK.c_deg(-109, -140, 600) + [0])],
    'B4': [(IK.c_deg(-248, -146, 450) + [0]), (IK.c_deg(-248, -146, 588) + [0])],
    'B5': [(IK.c_deg(-116, -246, 450) + [0]), (IK.c_deg(-116, -246, 549) + [0])],
    'B6': [(IK.c_deg(-254, -244, 450) + [0]), (IK.c_deg(-254, -244, 536) + [0])],
    'B7': [(IK.c_deg(-112, -142, 450) + [0]), (IK.c_deg(-112, -142, 555) + [0])],
    'B8': [(IK.c_deg(-250, -146, 450) + [0]), (IK.c_deg(-250, -146, 547) + [0])]
