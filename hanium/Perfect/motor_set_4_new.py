...
pick_position = {
    ...
    '1_2': [IK.c_deg(65, 170, 450),   IK.c_deg(65, 170, 602),   IK.c_deg(65, 170, 450)],
    '1_3': [IK.c_deg(60, 310, 450),   IK.c_deg(60, 310, 585),   IK.c_deg(60, 310, 450)],
    '1_4': [IK.c_deg(-97, 310, 450),  IK.c_deg(-97, 310, 584),  IK.c_deg(-97, 310, 450)],
    '2_1': [IK.c_deg(-110, 175, 450), IK.c_deg(-110, 175, 558), IK.c_deg(-110, 175, 450)],
    '2_2': [IK.c_deg(65, 170, 450),   IK.c_deg(65, 170, 558),   IK.c_deg(65, 170, 450)],
    '2_3': [IK.c_deg(59, 315, 450),   IK.c_deg(59, 315, 545),   IK.c_deg(59, 315, 450)],
    '2_4': [IK.c_deg(-103, 315, 450), IK.c_deg(-103, 315, 544), IK.c_deg(-103, 315, 450)],
    '3_1': [IK.c_deg(-122, 182, 450), IK.c_deg(-122, 182, 502), IK.c_deg(-122, 182, 450)],
    '3_2': [IK.c_deg(70, 177, 450),   IK.c_deg(70, 177, 500),   IK.c_deg(70, 177, 450)],
    '3_3': [IK.c_deg(70, 320, 450),   IK.c_deg(70, 320, 495),   IK.c_deg(70, 320, 450)],
    '3_4': [IK.c_deg(-114, 320, 450), IK.c_deg(-114, 320, 494), IK.c_deg(-114, 320, 450)]
}
# ---------------------------------------------------------------------------------------------------------------
# Place_Angle
place_position = {
...
place_position = {
    'A1': [flatpend(IK.c_deg(230, -240, 450), 0), flatpend(IK.c_deg(230, -240, 578), 0)],
    'A2': [flatpend(IK.c_deg(100, -240, 450), 0), flatpend(IK.c_deg(100, -240, 590), 0)],
    'A3': [flatpend(IK.c_deg(230, -144, 450), 0), flatpend(IK.c_deg(230, -144, 590), 0)],
    'A4': [flatpend(IK.c_deg(100, -144, 450), 0), flatpend(IK.c_deg(100, -144, 590), 0)],
    'A5': [flatpend(IK.c_deg(230, -240, 450), 0), flatpend(IK.c_deg(230, -240, 578), 0)],
    'A6': [flatpend(IK.c_deg(100, -240, 450), 0), flatpend(IK.c_deg(100, -240, 590), 0)],
    'A7': [flatpend(IK.c_deg(230, -144, 450), 0), flatpend(IK.c_deg(230, -144, 590), 0)],
    'A8': [flatpend(IK.c_deg(100, -144, 450), 0), flatpend(IK.c_deg(100, -144, 590), 0)],
    
    'B1': [flatpend(IK.c_deg(-165, -240, 450), 0), flatpend(IK.c_deg(-165, -240, 590), 0)],
    'B2': [flatpend(IK.c_deg(-252, -238, 450), 0), flatpend(IK.c_deg(-252, -238, 575), 0)],
    'B3': [flatpend(IK.c_deg(-105, -142, 450), 0), flatpend(IK.c_deg(-105, -142, 600), 0)],
    'B4': [flatpend(IK.c_deg(-248, -146, 450), 0), flatpend(IK.c_deg(-248, -146, 582), 0)],
    'B5': [flatpend(IK.c_deg(-116, -250, 450), 0), flatpend(IK.c_deg(-116, -250, 542), 0)],
    'B6': [flatpend(IK.c_deg(-252, -247, 450), 0), flatpend(IK.c_deg(-252, -247, 534), 0)],
    'B7': [flatpend(IK.c_deg(-105, -142, 450), 0), flatpend(IK.c_deg(-105, -142, 548), 0)],
    'B8': [flatpend(IK.c_deg(-248, -146, 450), 0), flatpend(IK.c_deg(-248, -146, 555), 0)]
}
...
safe_position = {
    # PALLET A   
    'AS1' : [flatpend(IK.c_deg(230, -240, 450), 0), Home],
    'AS2' : [flatpend(IK.c_deg(100, -240, 450), 0), Home],
    'AS3' : [flatpend(IK.c_deg(230, -144, 450), 0), Home],
    'AS4' : [flatpend(IK.c_deg(100, -144, 450), 0), Home],
    'AS5' : [flatpend(IK.c_deg(230, -240, 450), 0), Home],
    'AS6' : [flatpend(IK.c_deg(100, -240, 450), 0), Home],
    'AS7' : [flatpend(IK.c_deg(230, -144, 450), 0), Home],
    'AS8' : [flatpend(IK.c_deg(100, -144, 450), 0), Home],

    # PALLET B  
    'BS1' : [flatpend(IK.c_deg(-165, -240, 450), 0), Home],
    'BS2' : [flatpend(IK.c_deg(-252, -238, 450), 0), Home],
    'BS3' : [flatpend(IK.c_deg(-105, -142, 450), 0), Home],
    'BS4' : [flatpend(IK.c_deg(-248, -146, 450), 0), Home],
    'BS5' : [flatpend(IK.c_deg(-116, -250, 450), 0), Home],
    'BS6' : [flatpend(IK.c_deg(-252, -247, 450), 0), Home],
    'BS7' : [flatpend(IK.c_deg(-105, -142, 450), 0), Home],
    'BS8' : [flatpend(IK.c_deg(-248, -146, 450), 0), Home]
}          
