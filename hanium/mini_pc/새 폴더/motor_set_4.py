...
place_position = {
    ...
    # PALLET A   
    'A1' : [[-40,-6,48,0], [4,27,69,0]],
    'A2' : [[-47,3,26,0],  [-5,32,50,0]],
    'A3' : [[-30,-23,37,0],[8,15,59,0]],
    'A4' : [[-41,-10,15,0],[-2,21,40,0]],
    'A5' : [[-40,-6,48,0], [-8,16,61,0]],
    'A6' : [[-47,3,26,0],  [-17,22,41,0]],
    'A7' : [[-30,-23,37,0],[-6,3,51,0]],
    'A8' : [[-41,-10,15,0],[-14,11,32,0]],
    
    # PALLET B  
    'B1' : [[-35,48,-4,0], [2,66,28,0]],
    'B2' : [[-46,24,4,0],  [-5,49,35,0]],
    'B3' : [[-36,35,-23,0],[6,58,17,0]],
    'B4' : [[-43,12,-9,0], [-2,38,22,0]],
    'B5' : [[-35,48,-4,0], [-9,60,18,0]],
    'B6' : [[-46,24,4,0],  [-16,41,26,0]],
    'B7' : [[-36,35,-23,0],[-6,51,6,0]],
    'B8' : [[-43,12,-9,0], [-14,31,13,0]]
}
