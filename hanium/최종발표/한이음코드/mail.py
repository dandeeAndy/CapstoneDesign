...
my_account = 'schahn131@naver.com'
my_password = 'naver$ehdojtm``'

excel_path = 'C:/Users/Lee/Desktop/Perfect/QR_Data/qr_data.xlsx'  # 엑셀 파일 경로 설정
...
def send_logitics_data():
    ...
    for sheet_name in ['Position A', 'Position B']:
        ...
        for i, email in enumerate(email_addresses):
            ...
            body = f"안녕하세요. JALK3 입니다.\n\n해당 화물의 분류가 완료 되었습니다.\n\n{appointment_time.strftime('%H:%M')}에 오시면 되겠습니다.\n\n감사합니다."
            msg = make_mime_text(mail_to=email, subject='[JALK3] 운송일정안내', body=body)
            send_email(msg)
