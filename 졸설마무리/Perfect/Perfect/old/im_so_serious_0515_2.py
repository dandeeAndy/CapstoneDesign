            ...
            with lock:
                for obj in decoded_objects:
                    ...
                    if qr_data != last_qr_data:
                        ...
                        recognition_time = pd.Timestamp.now()
                        ...
                        QR_data = f"{qr_data}/{recognition_time}"
...
def motor_move(option, data_queue_QR):
    ...
    if not data_queue_QR.empty():
        ...
        if motor_key:
            ...
            position_angle = motor_set_3.position_mapping[position]
    ...
    Motor_data = f"{position}/{datetime.now()}"
