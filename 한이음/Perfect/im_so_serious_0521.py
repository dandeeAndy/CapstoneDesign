            ...
            with lock:
                for obj in decoded_objects:
                    ...
                    if qr_data != last_qr_data:
                        ...
                        qr_data_list.append({'Classification': classifi, 'Package Number': PackageNumber, 'Email': Email, 'Destination': Destination, 'PhoneNumber': PhoneNumber, 'Recognition time': recognition_time, 'Position': None})
